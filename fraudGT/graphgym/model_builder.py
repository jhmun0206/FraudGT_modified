...
from fraudGT.graphgym.models.hgt import HGTNet  # HGT implementation

# Register networks once (avoid KeyError if this file is imported multiple times)
if 'hgt' not in network_dict:
    register_network('hgt', HGTNet)

if 'gnn' not in network_dict:
