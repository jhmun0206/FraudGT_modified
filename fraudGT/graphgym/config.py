...
def set_cfg(cfg):
    ...
    # FraudGT hetero 옵션 (없어서 KeyError 발생하던 부분)
    cfg.dataset.add_ports = False
    cfg.dataset.reverse_mp = False
    cfg.dataset.hetero = False
    ...
    # Number of workers for data loading (train)
    cfg.train.num_workers = None  # None이면 cfg.num_workers 사용
    ...
    # Target node type for heterogeneous graphs (used by HGT)
    cfg.gnn.target_ntype = None
    
    # Edge type for heterogeneous graphs (used by HGT)
    cfg.gnn.edge_type = 'rel'
